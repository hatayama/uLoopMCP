...
public static class PushNotificationConstants
{
    ...
    public const string CHANGE_TYPE_ADDED = "TOOLS_ADDED";
    public const string CHANGE_TYPE_REMOVED = "TOOLS_REMOVED";
    public const string CHANGE_TYPE_MODIFIED = "TOOLS_MODIFIED";
}

/// <summary>
/// Push通知シリアライゼーションテスト用クラス
/// </summary>
public static class PushNotificationSerializer
{
    public static io.github.hatayama.uLoopMCP.PushNotification CreateConnectionEstablishedNotification(string endpoint)
    {
        return new io.github.hatayama.uLoopMCP.PushNotification
        {
            type = PushNotificationConstants.CONNECTION_ESTABLISHED,
            timestamp = DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ss.fffZ"),
            payload = new io.github.hatayama.uLoopMCP.NotificationPayload
            {
                endpoint = endpoint,
                clientInfo = new io.github.hatayama.uLoopMCP.ClientInfo
                {
    ...
    public static io.github.hatayama.uLoopMCP.PushNotification CreateDomainReloadNotification()
    {
        return new io.github.hatayama.uLoopMCP.PushNotification
        {
            ...
            payload = new io.github.hatayama.uLoopMCP.NotificationPayload
            {
                reason = new io.github.hatayama.uLoopMCP.DisconnectReason
                {
                    type = PushNotificationConstants.DOMAIN_RELOAD,
    ...
    public static io.github.hatayama.uLoopMCP.PushNotification CreateDomainReloadRecoveredNotification()
    {
        return new io.github.hatayama.uLoopMCP.PushNotification
        {
    ...
    public static io.github.hatayama.uLoopMCP.PushNotification CreateDisconnectNotification(string reasonType, string message)
    {
        return new io.github.hatayama.uLoopMCP.PushNotification
        {
            type = reasonType,
    ...
    public static io.github.hatayama.uLoopMCP.PushNotification CreateToolsChangedNotification(int toolCount, string[] changedTools, string changeType)
    {
        return new io.github.hatayama.uLoopMCP.PushNotification
        {
            ...
            payload = new io.github.hatayama.uLoopMCP.NotificationPayload
            {
                toolsInfo = new io.github.hatayama.uLoopMCP.ToolsInfo
                {
                    toolCount = toolCount,
    ...
    public static string SerializePushNotification(io.github.hatayama.uLoopMCP.PushNotification notification)
    {
        return JsonUtility.ToJson(notification);
    }

    public static io.github.hatayama.uLoopMCP.PushNotification DeserializePushNotification(string json)
    {
        return JsonUtility.FromJson<io.github.hatayama.uLoopMCP.PushNotification>(json);
    }

    public static bool ValidatePushNotification(string json, out io.github.hatayama.uLoopMCP.PushNotification parsed)
    {
        parsed = null;
        ...
        try
        {
            parsed = JsonUtility.FromJson<io.github.hatayama.uLoopMCP.PushNotification>(json);
            return parsed != null && !string.IsNullOrEmpty(parsed.type);
        }
        catch
        {
            return false;
