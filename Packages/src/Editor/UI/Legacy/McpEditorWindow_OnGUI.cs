...
namespace io.github.hatayama.uLoopMCP
{
    ...
    /// </summary>
    public class McpEditorWindow_OnGUI : EditorWindow
    {
        // Configuration services factory
        private McpConfigServiceFactory _configServiceFactory;

        // View layer
        private McpEditorWindowView_OnGUI _view;
        ...
        {
            McpEditorWindow_OnGUI window = GetWindow<McpEditorWindow_OnGUI>(McpConstants.PROJECT_NAME);
            window.Show();
        }
        ...
        {
            _view = new McpEditorWindowView_OnGUI();
        }
        ...
        {
            _eventHandler = new McpEditorWindowEventHandler(_model, (McpEditorWindow)(object)this);
