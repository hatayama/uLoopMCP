...
{
    /// <summary>
    /// Security settings management for .uloop/settings.json.
    ...
    public static class ULoopSettings
    {
        ...
        private static void LoadSettings()
        {
            ...
            // .uloop/settings.json does not exist yet — attempt migration from legacy file
        ...
        /// <summary>
        /// One-time migration: .uloop/settings.json absence is used as the trigger
