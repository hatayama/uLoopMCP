...
description: Get Unity Hierarchy structure via uloop CLI. Use when you need to inspect scene structure, find GameObjects, check component attachments, or understand scene organization.
---
