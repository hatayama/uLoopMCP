...
description: Search Unity project via uloop CLI. Use when you need to find assets, scenes, prefabs, scripts, or any project resources using Unity's search system.
---
