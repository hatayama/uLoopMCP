...
export const ERROR_MESSAGES = {
  ...
  TIMEOUT:
    'timed out waiting for Unity response (uLoopMCP). Unity may be frozen or busy. Please report this to the user and ask how to proceed. Do NOT kill Unity processes without user permission.',
