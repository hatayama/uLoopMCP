...
description: Execute Unity Test Runner via uloop CLI. Use when you need to run unit tests, integration tests, or verify code changes with EditMode/PlayMode tests.
---
